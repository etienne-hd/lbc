...
- Implemented multiple search using conditional OR operators.

### Changed

- Updated dependencies.
- Simplified the DataDome 403 error message. #13

## 1.1.4

### Changed

- Changed `lbc.Ad.attributes` from `list[Attribute]` to `dict[str, Attribute]` for easier and more intuitive access. **(Breaking change: this may break existing code and require reimplementing attribute-related logic.)** #12
